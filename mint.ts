...
import { DataV2, createCreateMetadataAccountV3Instruction } from '@metaplex-foundation/mpltoken-metadata';
import { bundlrStorage, keypairIdentity, Metaplex, UploadMetadataInput } from '@metaplexfoundation/js';
...
console.log(`Succesfully minted ${MINT_CONFIG.numberTokens}
